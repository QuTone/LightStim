...
class CircuitBuilder:
    ...
    # --------------------------------------------------------------------------
    # B. Mid-Circuit Operations (Syndrome Extraction, Logical Gates, etc.)
    # --------------------------------------------------------------------------
    def apply_syndrome_extraction(self, 
        ...
        back_propagated_paulis, syn_qubit_indices = self._get_back_propagated_pauli(circuit_chunk)
    ...
    # --------------------------------------------------------------------------
    # C. Final Measurement (Readout on Data Qubits)
    # --------------------------------------------------------------------------
    def apply_final_readout(self, final_measurements: Dict[int, str] = None):
        """
    ...
    @staticmethod
    def _get_back_propagated_pauli(circuit_chunk: stim.Circuit) -> np.ndarray:
        """
