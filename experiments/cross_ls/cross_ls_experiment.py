...
from src.qec_code.surface_code.unrotated import UnrotatedSurfaceCode, UnrotatedSurfaceCodeExtractionBlock, UnrotatedSurfaceCodeLogicalOpSet
from src.noise.config import NoiseConfig

from src.qec_code.PQRM.pqrm_patch import PQRMPatch, LOG_PQRM_LEN_DICT
from src.qec_code.PQRM.pqrm_operation import PQRMLogicalOpSet
...
class CrossLSExperiment(QECExperiment):
    ...
    def build(self) -> stim.Circuit:
        ...
        from src.ir.tracker import UNMEASURED_STAB_RECORD
        n = self.system.num_qubits
