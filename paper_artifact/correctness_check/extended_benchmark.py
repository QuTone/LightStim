...
try:
    ...
    p_ = '/home/xiang/workspace/LightStim/benchmarks/logical_circuits/distillation/tg_7to1'
...
try:
    ...
    p_ = '/home/xiang/workspace/LightStim/benchmarks/logical_circuits/distillation/ls_7to1'
    if p_ in sys.path: sys.path.remove(p_)
