"""
Regenerate fig1_cnot_ls_zz_xx.png — LS CNOT ZZ->XX logical error rate.
...
OUTPUT      = RESULTS / "fig1_cnot_ls_zz_xx.png"
...
if __name__ == "__main__":
    ...
    csv = _resolve("fig1_cnot_ls_zz_xx.csv")
    df = pd.read_csv(csv)
    plot(df)
