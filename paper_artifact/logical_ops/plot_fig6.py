...
OUTPUT      = RESULTS / "fig6_memory.png"
...
def _resolve(filename: str) -> Path:
    ...
    raise FileNotFoundError(
        f"{filename} not found in results/ or precomputed/\n"
        "Memory baseline has no precomputed data. "
        "Run: PYTHONPATH=. venv/bin/python paper_artifact/logical_ops/run_all.py --figure 6"
    )
