"""
Regenerate fig3_cnot_trans.png — Transversal CNOT logical error rate.
...
OUTPUT      = RESULTS / "fig3_cnot_trans.png"
...
if __name__ == "__main__":
    ...
    csv = _resolve("fig3_cnot_trans.csv")
    df = pd.read_csv(csv)
    plot(df)
