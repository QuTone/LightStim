...
from lightstim.qec_code.PQRM.pqrm_patch import _SYNDROME_BOUND_CONFIG
from lightstim.qec_code.PQRM.pqrm_se_config import TICK_DELTA_BULK, TICK_DELTA_BOUNDARY
